<template>
  <div>
    ...
    <flex-popup ref="flexPop">
      ...
      <textarea v-model="concatForm.des" placeholder="请输入您的需求描述，如：配方功效、样品获取或技术支持等"></textarea>
      <input type="text" v-model="concatForm.name" placeholder="请输入姓名">
      <input type="number" v-model="concatForm.tel" placeholder="请输入手机号">
      <p class="red-text">*您的手机号已被加密，配方师无法查看</p>
      <p class="red-text">*您的需求提交成功后，妆配库会将配方师的回复内容以短信方式发送至您的手机</p>
